...
err = NF_OPEN("h_stars_for_error_norm_calc.non_orth.cartesian_conv.TC_5_Gauss_mtn.dx_100km.dsgrid2.nc",NF_NOWRITE,ncid_in)
...
err = NF_INQ_VARID(ncid_in,'h_star_100km',varid)
